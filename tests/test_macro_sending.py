"""The sending side of macros — `run on` and `on sent order` — over two
...
from mkfix.macro.instance import COMPLETED, FAILED, LISTENING, PASSED, STOPPED
...
class TestExamples:
    ...
    def test_the_whole_language_is_covered(self):
        ...
        from mkfix.macro.nodes import Action, After, Expect, If, Repeat, Wait, When
