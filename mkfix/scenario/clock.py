"""Time for scripts, real or virtual, and knowing when they have all gone quiet.

A script spends its life parked — in an `after`, or waiting for an event —
...
class VirtualClock(Clock):
    ...
    every timer due in that span, in order, letting the scripts settle after
