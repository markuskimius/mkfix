...
if TYPE_CHECKING:
    from .runner import Run, MacroRunner
...
class ScriptError(Exception):
    """The macro cannot go on: an expression failed, an action was refused,
...
def event_map(kinds: tuple[str, ...] | list[str], source: str = "macro", *, request: str = "",
              msg: Any = None, prev: dict[str, Any] | None = None, **detail: Any) -> dict[str, Any]:
    """What a macro sees as `event`."""
